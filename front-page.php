...
<div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
  <div class="carousel-inner">
    ...
    <div class="carousel-item" data-interval="3000">
      <img class="d-block w-100" src="<?php echo get_template_directory_uri(); ?>/images/top_drone.jpg" alt="第2スライド">
    </div>
    <div class="carousel-item" data-interval="3000">
      <img class="d-block w-100" src="<?php echo get_template_directory_uri(); ?>/images/top_family.jpg" alt="第3スライド">
    </div>
    <div class="carousel-item" data-interval="3000">
      <img class="d-block w-100" src="<?php echo get_template_directory_uri(); ?>/images/top_3d.jpg" alt="第４スライド">
    </div>
  </div>
</div>
