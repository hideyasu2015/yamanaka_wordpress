  ...
  <div class="container">
    ...
    <div class="card-deck">
      ...
      <div class="card my-2 img-thumbnail col-lg-3" data-aos="fade-left" data-aos-duration="1000">
        ...
        <!-- </div> -->
        <!-- <div class="col-md-6 col-lg-3"> -->
        <div class="card my-2 img-thumbnail col-lg-3" data-aos="fade-left" data-aos-offset="150" data-aos-duration="1000">
          <div class="card_img">
            ...
            <seciton id="blog-section">
              <div class="container">
                ...
                while($news->have_posts()){
                  ...
                  <div class="row m-2 slide-left" data-aos-offset="300" data-aos="fade-in" data-aos-duration="1000">
