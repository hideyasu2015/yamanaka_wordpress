  ...
  <div class="article2">
    ...
    <div class="row">
      <div class="col-md-6 profile">
        <h4>プロフィール</h4>
        <ul>
          <li class="text-left">昭和53年広島生まれ</li>
          <li>広島県立  安古市高校</li>
          <li>大阪大学  外国語学部</li>
          <li>（旧大阪外国語大学）を卒業</li>
          ...
          <br>
          <li>
            <a href="http://takumi-officeyamanaka.tumblr.com/Office"><img src="<?php echo get_template_directory_uri(); ?>/images/icon-32x32.png" alt=""> Yamanaka別館 -匠屋- </a>
          </li>
          <li><a href="https://www.facebook.com/takumi.yamanaka"><i class="fab fa-facebook fa-fw fa-2x facebook-icon"></i></i> Facebook（気軽に友達申請して下さい）
          </a></li>
          </ul>
        <br>
        <br>
      ...
      <div class="col-md-6">
        <img src="<?php echo get_template_directory_uri(); ?>/images/member.jpg" class="img-fluid" alt="">
    </div>
  </div>
  </div>
  </div>
